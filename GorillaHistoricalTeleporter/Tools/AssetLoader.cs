...
namespace GorillaHistoricalTeleporter.Tools
{
    public class AssetLoader
    {
        ...
        private static async Task LoadAssetBundle()
        {
            ...
            Stream stream = typeof(Plugin).Assembly.GetManifestResourceStream("GorillaHistoricalTeleporter.Content.mapteleporter");
